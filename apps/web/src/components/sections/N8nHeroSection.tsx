...
export function N8nHeroSection() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-obsidian scan-lines noise flex">
      ...
      >
        <h1 className="text-watermark text-[4rem] sm:text-[6rem] md:text-[10rem] lg:text-[14rem] xl:text-[18rem] font-display font-extrabold uppercase tracking-[0.05em] leading-none whitespace-nowrap">
          n8n
        </h1>
      </motion.div>
