...
import { Workflow, Zap, ArrowRight, ExternalLink } from 'lucide-react'
...
const ctaItems = [
  ...
  { label: '30-Min Discovery Call', status: 'ACTIVE' },
]
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
            ...
            <div className="relative">
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-display font-extrabold uppercase tracking-tight leading-tight mb-6">
                ...
                <span className="relative inline-block">
                  <span className="text-lime">Workflows</span>
                  <motion.span
          ...
          >
            ...
            <span>•</span>
            <span>START_TIME: IMMEDIATE</span>
            <span>•</span>
            <span>SUPPORT: ONGOING</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
