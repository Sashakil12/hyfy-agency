...
import { Bot, ArrowRight, Calendar, Mail, Phone } from 'lucide-react'
    ...
    <section className="relative py-32 px-4 bg-obsidian overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          ...
          >
            Build Your <span className="text-lime">AI-Native App</span>
          </motion.h2>
          ...
          >
            Ready to integrate AI into your product? Let's discuss your vision and build intelligent
