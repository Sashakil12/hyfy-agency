...
import { BrainCircuit, Sparkles, ArrowRight, ExternalLink } from 'lucide-react'
import { useRef } from 'react'

import { GlowButton } from '@/components/GlowButton'

const ctaItems = [
  { label: 'Case Studies Available', status: 'READY' },
  { label: '30-Min Strategy Call', status: 'ACTIVE' },
  { label: 'Free AI Assessment', status: 'AVAILABLE' },
]

export function AiNativeCTASection() {
        ...
        >
          <div className="relative p-12 rounded-lg border border-lime/20 glass-panel overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-display font-extrabold uppercase tracking-tight leading-tight mb-6">
                ...
                <span className="relative inline-block">
                  <span className="text-lime">AI Native</span>
                  <motion.span
            ...
            <p className="text-xl md:text-2xl text-slate max-w-2xl mx-auto mb-8">
              See real AI applications we've built. From LLM integrations to predictive
              analytics—discover what's possible.
            </p>
            ...
            >
              <ExternalLink className="w-4 h-4 group-hover:text-lime transition-colors" />
          ...
          >
            ...
            <span>•</span>
            <span>SPEED: 65%_FASTER</span>
            <span>•</span>
            <span>STACK: FULL_AI</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
